...
class LLMAgent:
    ...
    def process_output(self, result: Any) -> str:
        """Process the output generated by the AI agent to be user friendly."""

        if result is None:
            return "Error: No valid response from the LLM Agent, try again..."

        response_type = result.response_type
        if response_type == "CraftResponse":
